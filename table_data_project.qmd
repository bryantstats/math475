...
The project has two parts. Part 1 is a written part where you are asked address all the below questions.  Part is the presentation part where you present question 27 to 30 and the modeling part. The calculation should be done using SAS Enterprise Guide. 
