...
The project has two parts. Part 1 is a written part where you are asked address all the below questions.  Part is the presentation part where you present question 27 to 30 and the modeling part. 
...
7. What is the name of the provider that has the highest total charge?
...
29. Explore a new variable that has not been mentioned in the previous question. 
